...
public class FragmentCompositionModelImpl
	 ...
	 */
	@Deprecated
	public static final long FRAGMENTCOMPOSITIONKEY_COLUMN_BITMASK = 8L;
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put(
				"userId", FragmentComposition::getUserId);
			attributeGetterFunctions.put(
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		private static final Map
			<String, BiConsumer<FragmentComposition, Object>>
		...
		static {
			Map<String, BiConsumer<FragmentComposition, ?>>
				attributeSetterBiConsumers =
					new LinkedHashMap
						<String, BiConsumer<FragmentComposition, ?>>();
	...
	public CacheModel<FragmentComposition> toCacheModel() {
		...
		fragmentCompositionCacheModel.externalReferenceCode =
			getExternalReferenceCode();
		...
		if ((externalReferenceCode != null) &&
			...
			fragmentCompositionCacheModel.externalReferenceCode = null;
		}
