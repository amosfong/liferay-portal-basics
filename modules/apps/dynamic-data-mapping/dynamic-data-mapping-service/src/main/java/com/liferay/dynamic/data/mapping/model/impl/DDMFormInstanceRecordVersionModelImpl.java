...
public class DDMFormInstanceRecordVersionModelImpl
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put(
				"statusByUserId",
				DDMFormInstanceRecordVersion::getStatusByUserId);
			attributeGetterFunctions.put(
				"statusByUserName",
	...
	static {
		...
		columnBitmasks.put("formInstanceRecordVersionId", 2L);
		...
		columnBitmasks.put("formInstanceVersion", 256L);

		columnBitmasks.put("formInstanceRecordId", 512L);

		columnBitmasks.put("version", 1024L);

		columnBitmasks.put("storageId", 2048L);
