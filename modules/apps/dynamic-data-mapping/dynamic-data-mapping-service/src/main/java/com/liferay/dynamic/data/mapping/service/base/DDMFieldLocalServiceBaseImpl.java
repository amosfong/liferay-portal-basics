...
/**
 * Provides the base implementation for the ddm field local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.dynamic.data.mapping.service.impl.DDMFieldLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.dynamic.data.mapping.service.impl.DDMFieldLocalServiceImpl
 * @generated
 */
public abstract class DDMFieldLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DDMFieldLocalService, IdentifiableOSGiService {
	...
	public DDMField addDDMField(DDMField ddmField) {
		...
		return ddmFieldPersistence.update(ddmField);
	}
	...
	public DDMField createDDMField(long fieldId) {
		return ddmFieldPersistence.create(fieldId);
	}
	...
	public DDMField deleteDDMField(long fieldId) throws PortalException {
		return ddmFieldPersistence.remove(fieldId);
	}
	...
	public DDMField deleteDDMField(DDMField ddmField) {
		return ddmFieldPersistence.remove(ddmField);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return ddmFieldPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DDMField.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ddmFieldPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return ddmFieldPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ddmFieldPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return ddmFieldPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DDMField fetchDDMField(long fieldId) {
		return ddmFieldPersistence.fetchByPrimaryKey(fieldId);
	}
	...
	public DDMField getDDMField(long fieldId) throws PortalException {
		return ddmFieldPersistence.findByPrimaryKey(fieldId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ddmFieldLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DDMField.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			ddmFieldLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DDMField.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return ddmFieldPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DDMFieldLocalServiceImpl#deleteDDMField(DDMField) to avoid orphaned data");
		}

		return ddmFieldLocalService.deleteDDMField((DDMField)persistedModel);
	}

	@Override
	public BasePersistence<DDMField> getBasePersistence() {
		return ddmFieldPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ddmFieldPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DDMField> getDDMFields(int start, int end) {
		return ddmFieldPersistence.findAll(start, end);
	}
	...
	public int getDDMFieldsCount() {
		return ddmFieldPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DDMFieldLocalService.class, IdentifiableOSGiService.class,
	...
	public String getOSGiServiceIdentifier() {
		return DDMFieldLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ddmFieldPersistence.getDataSource();
	...
	protected DDMFieldLocalService ddmFieldLocalService;

	@Reference
	protected DDMFieldPersistence ddmFieldPersistence;
