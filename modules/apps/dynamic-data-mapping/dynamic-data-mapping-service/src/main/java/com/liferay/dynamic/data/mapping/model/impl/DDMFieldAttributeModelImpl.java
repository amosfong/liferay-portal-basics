...
/**
 * The base model implementation for the DDMFieldAttribute service. Represents a row in the &quot;DDMFieldAttribute&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface <code>DDMFieldAttributeModel</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link DDMFieldAttributeImpl}.
 * </p>
 *
 ...
 * @generated
 */
public class DDMFieldAttributeModelImpl
	extends BaseModelImpl<DDMFieldAttribute> implements DDMFieldAttributeModel {
	...
	public DDMFieldAttributeModelImpl() {
	}
	...
	public void setPrimaryKey(long primaryKey) {
		setFieldAttributeId(primaryKey);
	}
	...
	public String getModelClassName() {
		return DDMFieldAttribute.class.getName();
	}
	...
	public Map<String, Object> getModelAttributes() {
		...
		for (Map.Entry<String, Function<DDMFieldAttribute, Object>> entry :
			...
			attributes.put(
				attributeName,
				attributeGetterFunction.apply((DDMFieldAttribute)this));
		}
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<DDMFieldAttribute, Object>>
			attributeSetterBiConsumers = getAttributeSetterBiConsumers();

		for (Map.Entry<String, Object> entry : attributes.entrySet()) {
			String attributeName = entry.getKey();

			BiConsumer<DDMFieldAttribute, Object> attributeSetterBiConsumer =
				attributeSetterBiConsumers.get(attributeName);

			if (attributeSetterBiConsumer != null) {
				attributeSetterBiConsumer.accept(
					(DDMFieldAttribute)this, entry.getValue());
			}
		}
	}
	...
	public long getOriginalFieldId() {
		return GetterUtil.getLong(this.<Long>getColumnOriginalValue("fieldId"));
	}
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(
			getCompanyId(), DDMFieldAttribute.class.getName(), getPrimaryKey());
	}
	...
	@Override
	public DDMFieldAttribute toEscapedModel() {
		if (_escapedModel == null) {
			Function<InvocationHandler, DDMFieldAttribute>
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof DDMFieldAttribute)) {
			return false;
		}

		DDMFieldAttribute ddmFieldAttribute = (DDMFieldAttribute)object;
	...
	@Override
	public CacheModel<DDMFieldAttribute> toCacheModel() {
		...
		ddmFieldAttributeCacheModel.companyId = getCompanyId();

		ddmFieldAttributeCacheModel.fieldId = getFieldId();
	...
	public <T> T getColumnValue(String columnName) {
		...
		return (T)function.apply((DDMFieldAttribute)this);
	}
