...
public class DDMFormInstanceVersionModelImpl
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put(
				"name", DDMFormInstanceVersion::getName);
			attributeGetterFunctions.put(
			...
			attributeGetterFunctions.put(
				"statusByUserName",
				DDMFormInstanceVersion::getStatusByUserName);
			attributeGetterFunctions.put(
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		private static final Map
			<String, BiConsumer<DDMFormInstanceVersion, Object>>
	...
	public <T> T getColumnValue(String columnName) {
		...
		Function<DDMFormInstanceVersion, Object> function =
		...
		return (T)function.apply((DDMFormInstanceVersion)this);
	}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put(
			"formInstanceVersionId", _formInstanceVersionId);
	...
	static {
		...
		columnBitmasks.put("formInstanceVersionId", 2L);
