...
public class DDMFieldAttributePersistenceTest {
	...
	protected OrderByComparator<DDMFieldAttribute> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"DDMFieldAttribute", "mvccVersion", true, "fieldAttributeId", true,
			"companyId", true, "fieldId", true, "storageId", true,
			"attributeName", true, "languageId", true, "smallAttributeValue",
			true);
	}
