...
public class DDMFieldPersistenceTest {
	...
	protected OrderByComparator<DDMField> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"DDMField", "mvccVersion", true, "fieldId", true, "companyId", true,
			"parentFieldId", true, "storageId", true, "structureVersionId",
			true, "fieldName", true, "fieldType", true, "instanceId", true,
