...
public class DLFileEntryTypePersistenceTest {
	...
	protected OrderByComparator<DLFileEntryType> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			"externalReferenceCode", true, "fileEntryTypeId", true, "groupId",
			true, "companyId", true, "userId", true, "userName", true,
			"createDate", true, "modifiedDate", true, "dataDefinitionId", true,
			"fileEntryTypeKey", true, "name", true, "description", true,
			"scope", true, "lastPublishDate", true);
	}
