...
public class DLFolderModelImpl
	 ...
	 */
	@Deprecated
	public static final long MOUNTPOINT_COLUMN_BITMASK = 32L;
	 ...
	 */
	@Deprecated
	public static final long REPOSITORYID_COLUMN_BITMASK = 256L;
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put(
				"modifiedDate", DLFolder::getModifiedDate);
			attributeGetterFunctions.put(
			...
			attributeGetterFunctions.put(
				"lastPostDate", DLFolder::getLastPostDate);
			attributeGetterFunctions.put(
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"companyId",
				(BiConsumer<DLFolder, Long>)DLFolder::setCompanyId);
			attributeSetterBiConsumers.put(
				"userId", (BiConsumer<DLFolder, Long>)DLFolder::setUserId);
			attributeSetterBiConsumers.put(
				"userName",
				(BiConsumer<DLFolder, String>)DLFolder::setUserName);
			attributeSetterBiConsumers.put(
				"createDate",
				(BiConsumer<DLFolder, Date>)DLFolder::setCreateDate);
			attributeSetterBiConsumers.put(
				"modifiedDate",
			...
			attributeSetterBiConsumers.put(
				"treePath",
				(BiConsumer<DLFolder, String>)DLFolder::setTreePath);
			attributeSetterBiConsumers.put(
			...
			attributeSetterBiConsumers.put(
				"statusDate",
				(BiConsumer<DLFolder, Date>)DLFolder::setStatusDate);
	...
	public CacheModel<DLFolder> toCacheModel() {
		...
		dlFolderCacheModel.externalReferenceCode = getExternalReferenceCode();

		String externalReferenceCode = dlFolderCacheModel.externalReferenceCode;

		if ((externalReferenceCode != null) &&
			(externalReferenceCode.length() == 0)) {

			dlFolderCacheModel.externalReferenceCode = null;
		}
	...
	public <T> T getColumnValue(String columnName) {
		...
		Function<DLFolder, Object> function =
