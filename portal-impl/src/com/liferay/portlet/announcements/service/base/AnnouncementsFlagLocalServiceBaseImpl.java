...
public abstract class AnnouncementsFlagLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AnnouncementsFlagLocalServiceImpl#deleteAnnouncementsFlag(AnnouncementsFlag) to avoid orphaned data");
		}
	...
	public void afterPropertiesSet() {
		AnnouncementsFlagLocalServiceUtil.setService(
			announcementsFlagLocalService);
	}

	public void destroy() {
		AnnouncementsFlagLocalServiceUtil.setService(null);
	}
