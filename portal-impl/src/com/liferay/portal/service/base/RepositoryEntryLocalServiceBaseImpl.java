...
public abstract class RepositoryEntryLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RepositoryEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RepositoryEntryLocalServiceUtil</code>.
	 */
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement RepositoryEntryLocalServiceImpl#deleteRepositoryEntry(RepositoryEntry) to avoid orphaned data");
		}
	...
	public void afterPropertiesSet() {
		RepositoryEntryLocalServiceUtil.setService(repositoryEntryLocalService);
	}

	public void destroy() {
		RepositoryEntryLocalServiceUtil.setService(null);
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RepositoryEntryLocalServiceBaseImpl.class);
