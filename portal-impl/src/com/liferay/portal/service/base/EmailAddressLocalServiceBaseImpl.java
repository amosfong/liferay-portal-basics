...
public abstract class EmailAddressLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmailAddressLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EmailAddressLocalServiceUtil</code>.
	 */
	...
	public EmailAddress fetchEmailAddressByExternalReferenceCode(
		...
		return emailAddressPersistence.fetchByERC_C(
	...
	public EmailAddress getEmailAddressByExternalReferenceCode(
		...
		return emailAddressPersistence.findByERC_C(
			externalReferenceCode, companyId);
	}
