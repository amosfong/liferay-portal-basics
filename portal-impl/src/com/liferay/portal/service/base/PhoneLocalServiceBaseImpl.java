...
public abstract class PhoneLocalServiceBaseImpl
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return phonePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Phone.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return phonePersistence.findWithDynamicQuery(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PhoneLocalServiceImpl#deletePhone(Phone) to avoid orphaned data");
		}
	...
	public void afterPropertiesSet() {
		PhoneLocalServiceUtil.setService(phoneLocalService);
	}
