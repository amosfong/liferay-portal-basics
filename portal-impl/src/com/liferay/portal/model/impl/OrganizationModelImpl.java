...
public class OrganizationModelImpl
	...
	static {
		...
		columnBitmasks.put("parentOrganizationId", 512L);
		...
		columnBitmasks.put("recursable", 8192L);

		columnBitmasks.put("regionId", 16384L);

		columnBitmasks.put("countryId", 32768L);

		columnBitmasks.put("statusListTypeId", 65536L);
